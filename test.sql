...
\echo 'Inserting 6 Repre_Interne. 1 has passed. 4 are starting to sell today, 1 is in the future';
...
SELECT * FROM Billet;
\echo 'Manully modify one billet';
...
\echo 'Adding incorrect cost of spectacle'
INSERT INTO Cout_Spectacle (id_spectacle, date_depenser, montant) VALUES
...
\echo 'Adding one cost of spectacle'
INSERT INTO Cout_Spectacle (id_spectacle, date_depenser, montant) VALUES
...
\echo 'Adding a spectacle created by theater into Repre_Externe'
INSERT INTO Repre_Externe (id_spectacle, id_compagnie_accueil, date_transac, prix, nombre_achete) VALUES
...
\echo 'Making incorrect reservations by insert'
...
\echo 'Ask price and make reservtion and pay reservation by function'
